"""Adaptador independente para o Sherlock."""
from pathlib import Path
import subprocess
from typing import Any


def run_sherlock(email: str, output_dir: Path) -> dict[str, Any]:
    output_dir.mkdir(parents=True, exist_ok=True)
    output_file = output_dir / "sherlock.txt"
    try:
        result = subprocess.run(["sherlock", email, "--print-found"], capture_output=True, text=True, encoding="utf-8", errors="replace", timeout=180, check=False)
