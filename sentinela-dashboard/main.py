...
from modulos.gestao import gerar_relatorio, obter_ultimo_relatorio, priorizar, reavaliar
from modulos.pentest import pentest_web
from modulos.utilidades import Vulnerabilidade, obter_logger
...
def relatorio_ultimo() -> dict[str, object]:
